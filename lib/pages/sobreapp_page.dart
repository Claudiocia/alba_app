...
class _PlaceSobreAppWidgetState extends State<PlaceSobreAppWidget> {
  ...
  final textParagrafo_1 = "Este aplicativo foi desenvolvido com o objetivo de ampliar a "
      ...
      "lançado no ano de 2021, este aplicativo representa a modernização do Legislativo "
      "baiano, com as tendências tecnológicas da atualidade.";
  ...
  final textParagrafo_2 = "Notícias, proposições em tramitação, acervo do AlbaCultural, "
      ...
      "Além disto o usuário poderá acompanhar o trabalho do seu deputado na Casa, "
      "participar dos debates, conhecer as proposições, homenagens e todas as demais "
